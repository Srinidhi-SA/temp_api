                    ...
                    <div className="main-content">
                        ...
                        <div className="row">
                            <div className="col-lg-12 text-right">
                                <Button type="button" onClick={this.saveAndShowModelSummary.bind(this)} bsStyle="primary">{(store.getState().apps.modelSummary.data.modelSelected)?"Model summery":"Save and show Model summary"}</Button>
                            </div>
                        </div>
                    </div>
                </div>
