   ...
   breadcrumb= (
    ...
    var OcrRevDocTableHtml = (
      this.props.OcrRevwrDocsList != '' ? (this.props.OcrRevwrDocsList.data.length != 0 ? this.props.OcrRevwrDocsList.data.map((item, index) => {
        ...
        : (<tr><td colSpan={9}><img src={STATIC_URL + "assets/images/Preloader_2.gif"} /></td></tr>)
        )
    let templateOptions= (this.props.OcrRevwrDocsList!=""?
    this.props.OcrRevwrDocsList.values.map((item,index)=>{
      return <li key={index}><a className={ this.props.template == item ? "active cursor" : "cursor" } onClick={this.filterRevDocrList.bind(this,item,'template')} name={item} data-toggle="modal" data-target="#modal_equal"> {item}</a></li>
    }):
      "")
    return (
    <div>
              ...
              <tr>
                ...
                <th className="dropdown" >
                  ...
                  <ul className="dropdown-menu scrollable-menu">
                    ...
                    <li><a className="cursor" onClick={this.filterRevDocrList.bind(this, 'pendingL1', 'status')}>Review Pending(L1)</a></li>
                    <li><a className="cursor" onClick={this.filterRevDocrList.bind(this, 'pendingL2', 'status')}>Review Pending(L2)</a></li>
                    <li><a className="cursor" onClick={this.filterRevDocrList.bind(this, 'reviewedL1', 'status')}>Review Completed(L1)</a></li>
                    <li><a className="cursor" onClick={this.filterRevDocrList.bind(this, 'reviewedL2', 'status')}>Review Completed(L2)</a></li>
                  </ul>
                </th>
                <th className="dropdown" >
