    ...
    bins = (
      <Tab.Pane>
        ...
        <div className="row form-group">
          ...
          <div className="col-sm-8">
            <select name="selectBinType" class="form-control" onChange={this.binningOptionsOnChange.bind(this)}> {binningOptions} </select>
          </div>
        </div>
        <div className="row form-group">
      ...
      <div>
        <Tab.Container id="left-tabs-example">
          <Row className="clearfix">
            <Col sm={15}>
              <Tab.Content animation>{bins}</Tab.Content>
            </Col>
          </Row>
        </Tab.Container>
      </div>
