        ...
        if(appsLists){
            ...
            appListTemplate = appsLists.map((data,index) => {
                ...
                var tagsList = data.tags.map((tagsList,i) => {
                    return ( <li key={i}><a href="#"><i className="fa fa-tag"></i>&nbsp;{tagsList.displayName}</a></li>)
                });
                return ( <div class="col-md-4 xs-mb-20">
                <div>
                
                <div className="app-block"> 
                <Link onClick={this.gotoAppsList.bind(this,data.id,data.name)} className="app-link" to='/apps/1/models'>
