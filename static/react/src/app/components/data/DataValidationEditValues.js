	  ...
	  const templateTextBoxes = dataSetColumnRemoveValues.map((data,id) =>{
		  ...
		  return (
				<div className="form-group" id={data.id} key={id}>
					...
					<div className="col-sm-1 cursor" onClick={this.removeComponents.bind(this,data,REMOVE)}>
						<i className="fa fa-minus-square-o text-muted"></i>
					</div>
				</div>
			);
		});
	    ...
	    if(that.columnData != null){
		  ...
		  return (
				<div className="form-group" id={data.replaceId} key={data.replaceId}>
					...
					<div className="col-sm-1 cursor" onClick={this.removeComponents.bind(this,data,REPLACE)}>
