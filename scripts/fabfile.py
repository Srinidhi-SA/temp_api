...
def deploy_api():
    with cd("/home/ubuntu/env_deployment/mAdvisor-api"):
        ...
        ifReqInstAPI = raw_input("API Requirements installation required?(y/n)")
        ifMigrateAPI = raw_input("Database migrations required?(y/n)")
        ...
        ifReqInstSPARK = raw_input("SPARK Requirements installation required?(y/n)")
        ...
        reloadCelery = raw_input("Celery reload required?(y/n)")
