...
class Trainer(models.Model):
    ...
    def generate_config(self, *args, **kwargs):
        ...
        elif self.mode=='autoML':
            config['config']["COLUMN_SETTINGS"]=self.get_targetColumn_for_variableSelection_autoML()

            from config.settings import feature_engineering_settings
            fe_default_settings=feature_engineering_settings.feature_engineering_ml_settings
            dc_default_settings=feature_engineering_settings.data_cleansing_final_config_format
