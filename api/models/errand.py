...
# model_helper_c3 related imports
...
class Errand(models.Model):
    ...
    def get_result(self):
        ...
        try:
            ...
            output = model_helper_c3.manipulate_results_histogram_bins(output)
    ...
    def get_decision_tree_regression_narratives(self):
        ...
        try:
            ...
            try:
                output = model_helper_c3.manipulate_decision_tree_narrative_card2_chart(output)
            except:
                pass
        except Exception as error:
            print error
    ...
    def get_density_histogram(self):
        path = self.storage_output_dir() + "/results/DensityHistogram"
