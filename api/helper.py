    ...
    def get_config(cls,
        ...
        return {
            "job_config": {
                ...
                "job_url" : "https://{0}:{1}/api/job/{2}/".format(THIS_SERVER_DETAILS.get('host'),
                                                                    THIS_SERVER_DETAILS.get('port'),
                                                                    slug),
                "message_url": "https://{0}:{1}/api/messages/{2}/".format(THIS_SERVER_DETAILS.get('host'),
                                                                THIS_SERVER_DETAILS.get('port'),
                                                                message_slug),
                "xml_url": "https://{0}:{1}/api/xml/{2}/".format(THIS_SERVER_DETAILS.get('host'),
                                                                THIS_SERVER_DETAILS.get('port'),
                                                                slug),
                "error_reporting_url": "https://{0}:{1}/api/set_job_report/{2}/".format(THIS_SERVER_DETAILS.get('host'),
                                                                THIS_SERVER_DETAILS.get('port'),
                                                                slug),
                "job_name": job_name,
                "app_id":app_id,
