...
$COMMAND_PREFIX $SCRIPTS_ROOT/portfolio_analysis.py --input1 "hdfs://$1/$INPUT_FILE_1" --input2 "hdfs://$1/$INPUT_FILE_2" --input3 "hdfs://$1/$INPUT_FILE_3" --result "hdfs://$1:9000$5/portfolio-result.json" --narratives "hdfs://$1:9000$5/portfolio-narratives.json"
