...
ssh -i api/lib/mAdviser_key_pair.pem hadoop@ec2-54-88-153-37.compute-1.amazonaws.com spark-submit --master yarn  --deploy-mode client /hmoe/hadoop/codebase/marlabs-bi/bi/scripts/regression.py --input "hdfs://ip-172-31-3-88.ec2.internal:8020/$1" --result "hdfs://ip-172-31-3-88.ec2.internal:8020$2/reg-result.json" --narratives "hdfs://ip-172-31-3-88.ec2.internal:8020$2/reg-narratives.json"
